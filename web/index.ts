...
const TextInput = ({ value, oninput }: TextInputProps) => {
  return H("div", { className: "input-outer-wrapper" }, H("div", { className: "input-inner-wrapper" }, H("input", { type: "text", value, oninput: (e: any) => oninput(e.target.value) })));
};
...
const fileTypeOptions: DropdownOption[] = [{ text: "PNG", value: "png" }];
...
const imageLightOptions: DropdownOption[] = [{ text: "Logo", value: "http://iammatthias.com/images/safari-pinned-tab.svg" }];

const imageDarkOptions: DropdownOption[] = [{ text: "Logo", value: "http://iammatthias.com/images/safari-pinned-tab.svg" }];
...
const App = (_: any, state: AppState, setState: SetState) => {
  ...
  const { fileType = "png", fontSize = "100px", theme = "light", md = false, text = "I AM MATTHIAS", images = [imageLightOptions[0].value], widths = [], heights = [], showToast = false, messageToast = "", loading = true, selectedImageIndex = 0, overrideUrl = null } = state;
      ...
      H(
        ...
        H(Field, {
          ...
          input: H(Button, {
            ...
            onclick: () => {
              const nextImage = images.length === 1 ? "https://cdn.jsdelivr.net/gh/remojansen/logo.ts@master/ts.svg" : "";
