...
const imageLightOptions: DropdownOption[] = [{ text: 'Logo', value: 'https://og.iammatthias.com/img/logo-dark.png' }];

const imageDarkOptions: DropdownOption[] = [{ text: 'Logo', value: 'https://og.iammatthias.com/img/logo-light.png' }];
