...
const TextInput = ({ value, oninput, small, type = "text", placeholder = "" }: TextInputProps) => {
  return H("div", { className: "input-outer-wrapper" + (small ? " small" : "") }, H("div", { className: "input-inner-wrapper" }, H("input", { type, value, placeholder, oninput: (e: any) => oninput(e.target.value) })));
};
...
const imageLightOptions: DropdownOption[] = [{ text: "IAM", value: "https://iammatthias.com/images/safari-pinned-tab.svg" }];
